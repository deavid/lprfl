...
impl LengthUnit {
    ...
    pub fn names(&self) -> Vec<&str> {
        match self {
            ...
            LengthUnit::CentiMeter => vec!["cm", "centimeter", "centimeters"],
            LengthUnit::Mile => vec!["mi", "mile", "miles"],
            LengthUnit::Foot => vec!["ft", "foot", "feet"],
            LengthUnit::Inch => vec!["in", "inch", "inches"],
            LengthUnit::NanoMeter => todo!(),
            LengthUnit::MicroMeter => todo!(),
            LengthUnit::MegaMeter => todo!(),
            LengthUnit::Angstrom => todo!(),
            LengthUnit::Furlong => todo!(),
            LengthUnit::Chain => todo!(),
            LengthUnit::Rod => todo!(),
